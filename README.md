...
**⚠️ 注意**：请**保留并启用** JetBrains 官方中文语言包；社区包为增量补充。修改语言后请完整重启 IDE。
...
```powershell
python scripts/l10n.py build --version 1.0.4
```

IDEA → **设置 → 插件 → 从磁盘安装插件** → 选择 `releases/com.chinese.idea.localization-1.0.4.jar`
